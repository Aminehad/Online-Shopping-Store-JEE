...
<% 
		...
		System.out.print(em);
		if("-1".equals(em)){
			response.sendRedirect("../jsp/drones-fnru.jsp");
		}
		%>
<body>
	 <div class="cart-sidebar">
            ...
            <div class="cart-body">
                ...
                <hr/>
                <div class="cart-btn">
                    <a href="../html/checkout.html" class="btn-checkout">Checkout</a>
                </div>
            </div>
        </div>
      <main>
          <div class="main-container">
              <div class="main-title">Drones</div>
   ...
   try{
	...
	ResultSet rs=st.executeQuery("select *from product where category='drones'");
	while(rs.next()){%>
                      <li class="item">
