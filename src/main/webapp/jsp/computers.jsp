...
<head>
    ...
    <title>Shop All | Tech House</title>
		...
		System.out.print(em);
		if("-1".equals(em)){
			response.sendRedirect("../jsp/computers-fnru.jsp");
		}
		%>
<body>
      ...
      <main>
          <div class="main-container">
   			<div class="main-title">Computers</div>
   ...
   try{
	...
	ResultSet rs=st.executeQuery("select *from product where category='computers'");
	while(rs.next()){%>
                      <li class="item">
