	...
	while(rs.next()){%>
                      <li class="item">
                          ...
                          <a href="product-fnru.jsp" class="item-link">
                            ...
                            <p class="bs-price"><del>$<%out.print(rs.getFloat(3)+100);%></del>  $<% out.print(rs.getString(3));%></p> <!-- either u cross the price and minus 50 to the new one or leave it like this -->
                        </a>
                      </li>
                  <% }
   }         
