...
<% 
		...
		System.out.print(em);
		if("-1".equals(em)){
			response.sendRedirect("../jsp/sale-fnru.jsp");
		}
		%>
<body>
   ...
   try{
	...
	ResultSet rs=st.executeQuery("select *from product where category='sale'");
	while(rs.next()){%>
					  <li class="item">
                          ...
                          <a href="product.jsp" class="item-link">
                            ...
                            <p class="bs-price"><del>$<%out.print(rs.getFloat(3)+50);%></del> $<% out.print(rs.getString(3));%></p> <!-- either u cross the price and minus 50 to the new one or leave it like this -->
                        </a>
                      </li>
